  ...
  cnry: {
    functions: {
      ...
      isOwner: {
        name: 'is-owner',
        access: 'private',
        args: [{ name: 'tokenId', type: 'uint128' }],
        outputs: { type: 'bool' },
      } as TypedAbiFunction<[tokenId: TypedAbiArg<number | bigint, 'tokenId'>], boolean>,
      isValidKeepaliveExpiry: {
        name: 'is-valid-keepaliveExpiry',
        access: 'private',
        args: [{ name: 'keepaliveExpiry', type: 'uint128' }],
        outputs: { type: 'bool' },
      } as TypedAbiFunction<
        [keepaliveExpiry: TypedAbiArg<number | bigint, 'keepaliveExpiry'>],
        boolean
      >,
      isWithinKeepaliveExpiry: {
        name: 'is-within-keepaliveExpiry',
        access: 'private',
        args: [
          { name: 'keepaliveTimestamp', type: 'uint128' },
          { name: 'keepaliveExpiry', type: 'uint128' },
          { name: 'tokenId', type: 'uint128' },
        ],
        outputs: { type: 'bool' },
      } as TypedAbiFunction<
        [
          keepaliveTimestamp: TypedAbiArg<number | bigint, 'keepaliveTimestamp'>,
          keepaliveExpiry: TypedAbiArg<number | bigint, 'keepaliveExpiry'>,
      ...
      hatch: {
        ...
        access: 'public',
        args: [
          { name: 'cnryName', type: { 'string-utf8': { length: 32 } } },
          { name: 'cnryStatement', type: { 'string-utf8': { length: 280 } } },
        ],
        outputs: { type: { response: { ok: 'uint128', error: 'uint128' } } },
      } as TypedAbiFunction<
        [
          cnryName: TypedAbiArg<string, 'cnryName'>,
          cnryStatement: TypedAbiArg<string, 'cnryStatement'>
        ],
      ...
      setBaseUri: {
        name: 'set-base-uri',
        access: 'public',
        args: [{ name: 'new-base-uri', type: { 'string-ascii': { length: 210 } } }],
      ...
      setHatchPrice: {
        name: 'set-hatchPrice',
        access: 'public',
        args: [{ name: 'new-hatchPrice', type: 'uint128' }],
        outputs: { type: { response: { ok: 'bool', error: 'uint128' } } },
      } as TypedAbiFunction<
        [newHatchPrice: TypedAbiArg<number | bigint, 'newHatchPrice'>],
        Response<boolean, bigint>
      >,
      setKeepaliveExpiry: {
      ...
      setKeepalivePrice: {
        ...
        access: 'public',
        args: [{ name: 'new-keepalivePrice', type: 'uint128' }],
        outputs: { type: { response: { ok: 'bool', error: 'uint128' } } },
      } as TypedAbiFunction<
        [newKeepalivePrice: TypedAbiArg<number | bigint, 'newKeepalivePrice'>],
        Response<boolean, bigint>
      >,
      setName: {
        name: 'set-name',
      ...
      setProof: {
        ...
        args: [
          { name: 'tokenId', type: 'uint128' },
          { name: 'cnryProof', type: { 'string-ascii': { length: 210 } } },
        ],
        outputs: { type: { response: { ok: 'uint128', error: 'uint128' } } },
      } as TypedAbiFunction<
        [
          tokenId: TypedAbiArg<number | bigint, 'tokenId'>,
          cnryProof: TypedAbiArg<string, 'cnryProof'>
        ],
        Response<bigint, bigint>
      >,
      setStatement: {
      ...
      setUri: {
        ...
        args: [
          { name: 'tokenId', type: 'uint128' },
          { name: 'cnryUri', type: { 'string-ascii': { length: 210 } } },
        ],
        outputs: { type: { response: { ok: 'uint128', error: 'uint128' } } },
      } as TypedAbiFunction<
        [tokenId: TypedAbiArg<number | bigint, 'tokenId'>, cnryUri: TypedAbiArg<string, 'cnryUri'>],
        Response<bigint, bigint>
      >,
      setWatchPrice: {
        name: 'set-watchPrice',
        access: 'public',
        args: [{ name: 'new-watchPrice', type: 'uint128' }],
        outputs: { type: { response: { ok: 'bool', error: 'uint128' } } },
      } as TypedAbiFunction<
        [newWatchPrice: TypedAbiArg<number | bigint, 'newWatchPrice'>],
        Response<boolean, bigint>
      >,
      transfer: {
        name: 'transfer',
      ...
      getBaseUri: {
        ...
        outputs: { type: { 'string-ascii': { length: 210 } } },
      } as TypedAbiFunction<[id: TypedAbiArg<number | bigint, 'id'>], string>,
      getHatchPrice: {
        name: 'get-hatchPrice',
        access: 'read_only',
        args: [],
      ...
      getMetadata: {
        ...
        outputs: {
          type: {
            optional: {
              tuple: [
                { name: 'cnryKeeper', type: 'principal' },
                { name: 'cnryName', type: { 'string-utf8': { length: 32 } } },
                { name: 'cnryProof', type: { optional: { 'string-ascii': { length: 210 } } } },
                { name: 'cnryStatement', type: { 'string-utf8': { length: 280 } } },
                { name: 'cnryUri', type: { optional: { 'string-ascii': { length: 210 } } } },
                { name: 'hatchedTimestamp', type: 'uint128' },
      ...
      getTokenUri: {
        ...
        outputs: {
          type: {
            response: { ok: { optional: { 'string-ascii': { length: 210 } } }, error: 'uint128' },
          },
        },
      } as TypedAbiFunction<
        [tokenId: TypedAbiArg<number | bigint, 'tokenId'>],
        Response<string | null, bigint>
      >,
      getWatchPrice: {
        name: 'get-watchPrice',
        access: 'read_only',
      ...
      getWatcherCount: {
        ...
        outputs: {
          type: {
            response: { ok: { tuple: [{ name: 'count', type: 'uint128' }] }, error: 'none' },
          },
        },
      } as TypedAbiFunction<
        [tokenId: TypedAbiArg<number | bigint, 'tokenId'>],
    ...
    maps: {
      cnrys: {
        name: 'cnrys',
        key: { tuple: [{ name: 'tokenId', type: 'uint128' }] },
        value: {
          tuple: [
            { name: 'cnryKeeper', type: 'principal' },
            { name: 'cnryName', type: { 'string-utf8': { length: 32 } } },
      ...
      watcherCount: {
        name: 'watcher-count',
        key: { tuple: [{ name: 'tokenId', type: 'uint128' }] },
        value: { tuple: [{ name: 'count', type: 'uint128' }] },
      } as TypedAbiMap<
        {
          tokenId: number | bigint;
        },
    ...
    non_fungible_tokens: [{ name: 'CNRY', type: 'uint128' }],
    fungible_tokens: [],
    epoch: 'Epoch2_05',
  ...
  maintenance: {
    functions: {
      addMaintenanceMode: {
        ...
        access: 'public',
        args: [
          { name: 'commitHash', type: { 'string-ascii': { length: 7 } } },
          { name: 'maintenance', type: 'bool' },
          { name: 'wall', type: { 'string-ascii': { length: 280 } } },
        ],
        outputs: {
          type: {
            response: { ok: 'uint128', error: { response: { ok: 'none', error: 'uint128' } } },
          },
        },
      } as TypedAbiFunction<
        [
          commitHash: TypedAbiArg<string, 'commitHash'>,
          maintenance: TypedAbiArg<boolean, 'maintenance'>,
          wall: TypedAbiArg<string, 'wall'>
        ],
        Response<bigint, Response<null, bigint>>
      >,
      setMaintenance: {
        name: 'setMaintenance',
        access: 'public',
      ...
      setWall: {
        ...
        [commitHash: TypedAbiArg<string, 'commitHash'>, wall: TypedAbiArg<string, 'wall'>],
        Response<bigint, Response<null, bigint>>
      >,
      getMaintenanceMode: {
        name: 'getMaintenanceMode',
        access: 'read_only',
        args: [{ name: 'commitHash', type: { 'string-ascii': { length: 7 } } }],
        outputs: {
          type: {
            optional: {
              tuple: [
    ...
    maps: {
      maintenanceMode: {
        ...
        key: { tuple: [{ name: 'commitHash', type: { 'string-ascii': { length: 7 } } }] },
        value: {
          tuple: [
            { name: 'maintenance', type: 'bool' },
            { name: 'wall', type: { 'string-ascii': { length: 280 } } },
  ...
  watcher: {
    functions: {
      ...
      watchToken: {
        ...
        access: 'public',
        args: [
          { name: 'contract-name', type: { 'string-ascii': { length: 80 } } },
          { name: 'tokenId', type: 'uint128' },
          { name: 'watcherAddress', type: 'principal' },
        ],
        outputs: { type: { response: { ok: 'uint128', error: 'uint128' } } },
      } as TypedAbiFunction<
        [
          contractName: TypedAbiArg<string, 'contractName'>,
          tokenId: TypedAbiArg<number | bigint, 'tokenId'>,
          watcherAddress: TypedAbiArg<string, 'watcherAddress'>
        ],
        Response<bigint, bigint>
      >,
      getLastTokenId: {
      ...
      getMetadata: {
        ...
        outputs: {
          type: {
            optional: {
              tuple: [
                { name: 'contractTokenId', type: 'uint128' },
                { name: 'watcherAddress', type: 'principal' },
              ],
            },
          },
      ...
      getTokenUri: {
        ...
        outputs: {
          type: {
            response: { ok: { optional: { 'string-ascii': { length: 210 } } }, error: 'none' },
          },
        },
      } as TypedAbiFunction<
    ...
    maps: {
      watchedContract: { name: 'watched-contract', key: 'bool', value: 'principal' } as TypedAbiMap<
        boolean,
        string
      >,
      watchers: {
    ...
    non_fungible_tokens: [{ name: 'WATCHER', type: 'uint128' }],
    fungible_tokens: [],
    epoch: 'Epoch2_05',
    clarity_version: 'Clarity1',
...
export const accounts = {
  ...
  wallet_9: { address: 'STNHKEPYEPJ8ET55ZZ0M5A34J0R3N5FM2CMMMAZ6', balance: 100000000000000 },
} as const;
