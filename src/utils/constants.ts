...
export const DEFAULT_MAINNET_WATCHER_CONTRACT = process.env.NEXT_PUBLIC_MAINNET_WATCHER_CONTRACT || '';
export const DEFAULT_TESTNET_WATCHER_CONTRACT = process.env.NEXT_PUBLIC_TESTNET_WATCHER_CONTRACT || '';
export const DEFAULT_REGTEST_WATCHER_CONTRACT = process.env.NEXT_PUBLIC_REGTEST_WATCHER_CONTRACT || '';
export const DEFAULT_LOCALNET_WATCHER_CONTRACT = process.env.NEXT_PUBLIC_LOCALNET_WATCHER_CONTRACT || '';

export const DEFAULT_MAINNET_MAINTENANCE_CONTRACT = process.env.NEXT_PUBLIC_MAINNET_MAINTENANCE_CONTRACT || '';
export const DEFAULT_TESTNET_MAINTENANCE_CONTRACT = process.env.NEXT_PUBLIC_TESTNET_MAINTENANCE_CONTRACT || '';
export const DEFAULT_REGTEST_MAINTENANCE_CONTRACT = process.env.NEXT_PUBLIC_REGTEST_MAINTENANCE_CONTRACT || '';
export const DEFAULT_LOCALNET_MAINTENANCE_CONTRACT = process.env.NEXT_PUBLIC_LOCALNET_MAINTENANCE_CONTRACT || '';
